...
urlpatterns = [
    ...
    path('dj/monitoring/', views.dj_monitoring, name='dj_monitoring'),
    path('dj/monitoring/update-user/', views.update_user, name='update_user'),
    ...
    path('party/<int:party_id>/qr-code/', views.party_qr_code, name='party_qr_code'),
    ...
    path('party/<int:party_id>/toggle-allow-requests/', views.toggle_allow_requests, name='toggle_allow_requests'),
    ...
    path('songs/more/', views.song_list_more, name='song_list_more'),
